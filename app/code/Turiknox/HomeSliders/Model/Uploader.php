...
class Uploader
{
     ...
     * @var string
     */
    const IMAGE_TMP_PATH    = 'homesliders/tmp/sliders/image';
    /**
     * @var string
     */
    const IMAGE_PATH        = 'homesliders/sliders/image';
    /**
     * @var string
     */
    const FILE_TMP_PATH     = 'homesliders/tmp/sliders/file';
    /**
     * @var string
     */
    const FILE_PATH         = 'homesliders/sliders/file';
